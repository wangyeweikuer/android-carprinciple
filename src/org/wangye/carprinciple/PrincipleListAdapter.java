...
public class PrincipleListAdapter extends ArrayAdapter<PrincipleOrCategoryItem> {

    private final LayoutInflater vi;

    public PrincipleListAdapter(Context context, int resource, List<PrincipleOrCategoryItem> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PrincipleOrCategoryItem p = getItem(position);
        tt.setText(p.getDisplayText());
        tt.setTag(p);
        if (position % 2 == 0) {
